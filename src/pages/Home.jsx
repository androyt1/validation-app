...
const Home = () => {    
  return (
    <div className='w-full h-screen border-red-600 shadow-sm shadow-red-400'>
        ...
        <form action="" className='w-2/3 mx-auto py-6 px-5 border mt-8 bg-red-50'>
          <div className='grid grid-cols-4 w-full mb-4'>
              ...
              <input type="text" placeholder='Enter Your First Name' className='w-full bg-white p-1 border focus:outline-none focus:border-red-300' />
              </div>
          </div>
          ...
          <div className='grid grid-cols-4 w-full mb-4'>
              ...
              <div className='col-span-3'>
              <input type="text" placeholder='Enter Your Last Name' className='w-full bg-white p-1 border focus:outline-none focus:border-red-300' />
              </div>
          </div>
          ...
          <div className='grid grid-cols-4 w-full mb-4'>
              ...
              <div className='col-span-3'>
              <input type="text" placeholder='Enter Your Email Address' className='w-full bg-white p-1 border focus:outline-none focus:border-red-300' />
              </div>
          </div>
          ...
          <div className='grid grid-cols-4 w-full mb-4'>
              ...
              <div className='col-span-3'>
              <input type="text" placeholder='Enter Your Phone Number' className='w-full bg-white p-1 border focus:outline-none focus:border-red-300' />
              </div>
          </div>
